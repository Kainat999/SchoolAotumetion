...
from panel_app.EditResultView import EditResultView
...
urlpatterns = [
    ...
    path('list/', student_views.assessment_list, name='stu_assessment_list'),
    path('stu_assessments/<int:assessment_id>/', student_views.assessment_detail, name='stu_assessment_detail'),
    path('stu_assessments/<int:assessment_id>/take/', student_views.assessment_take, name='stu_assessment_take'),
