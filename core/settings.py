...
MIDDLEWARE = [
    ...
    # My Middleware
    'panel_app.middleware.LoginCheckMiddleWare',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': ['panel_app/templates'], #My App Templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AUTH_USER_MODEL = 'panel_app.CustomUser'
AUTHENTICATION_BACKENDS = ['panel_app.EmailBackend.EmailBackend']
